  ...
  return (
    <div className="gallery-event">
      <div className="gallery-event-info d-flex flex-column align-items-start justify-content-center">
        <h3 className="gallery-h3">Музичка Селекција</h3>
      ...
      <div className="gallery-carousel-container">
        ...
        >
          <div>
            <img
              src="/Img/Galerija/muzicka-selekcija-1.jpg"
              alt="muzicka-selekcija-1"
            />
          </div>
          <div>
            <img
              src="/Img/Galerija/muzicka-selekcija-2.jpg"
              alt="muzicka-selekcija-2"
            />
          </div>
          <div>
            <img
              src="/Img/Galerija/muzicka-selekcija-3.jpg"
              alt="muzicka-selekcija-3"
            />
          </div>
          <div>
            <img
              src="/Img/Galerija/muzicka-selekcija-4.jpg"
              alt="muzicka-selekcija-4"
            />
          </div>
        </Carousel>
      </div>
...
export default Gallery_carousel_3;
